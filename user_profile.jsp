...
try{
	  ...
	  String qry1="select id,name,mobile,email,address,city,state,password,pic from users where  id="+session.getAttribute("userid");
	  ...
	  if(rs.next())
	  {
		...
		out.println("<tr><th></th>");				
				...
				out.println("<th>pic</th>");		out.println("</tr>");
		out.println("</thead>");
		out.println("<tbody>");
		...
		{
			out.println("<tr>");			
			out.println("<th><A href='user_profile_edit_code.jsp?id="+rs.getString("id")+"'>Edit</th> ");					
				...
				out.println("<td><img src='"+path+"/uploads/"+rs.getString("pic")+"' width='100px' height='100px'></img></td>");			
			out.println("</tr>");
		}while(rs.next());
		out.println("</tbody>");
		out.println("<thead class='thead-light'>");
