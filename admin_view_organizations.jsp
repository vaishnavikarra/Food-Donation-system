...
try{
	  ...
	  if(rs.next())
	  {
		...
		{
			out.println("<tr>");			
			out.println("<th><A href='admin_view_organizations_edit_code.jsp?id="+rs.getString("id")+"'>Edit</th> <th><A href='admin_view_organizations_code.jsp?id="+rs.getString("id")+"'>Delete</A></th>");					
