...
<div class="container" style="background-color: #ccf5ff">
  <h2>Your Previous Money Donations</h2>
...
try{
	  ...
	  String qry1="select DATE_FORMAT(donate_date, '%d-%m-%Y') as date1 ,organization_id,amount from donate_money where user_id="+session.getAttribute("userid");
	  ResultSet rs=stmt.executeQuery(qry1);
	 if(rs.next())
	  {
		out.println("<br><table class='table table-bordered display' id='table_id'>");
		out.println("<thead class='thead-light'>");
		out.println("<tr>");out.println("<th>donate_date</th>");out.println("<th>charity</th>");out.println("<th>amount</th>");		out.println("</tr>");
		out.println("</thead>");
		out.println("<tbody>");
		...
		//get charity details
		 ...
		 out.println("<td>"+rs.getString("amount")+"</td>");		out.println("</tr>");
		}while(rs.next());
		out.println("</tbody>");
		out.println("<thead class='thead-light'>");
		out.println("<tr>");out.println("<th>donate_date</th>");out.println("<th>charity</th>");out.println("<th>amount</th>");		out.println("</tr>");
