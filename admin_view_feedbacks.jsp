...
try{
	  ...
	  String qry1="select DATE_FORMAT(A.fdate, '%d-%m-%Y') as date1,A.user_id,B.name,B.mobile,A.feedback from feedbacks A, users B where A.user_id=B.id order by A.fdate desc";
	  ResultSet rs=stmt.executeQuery(qry1);
	 if(rs.next())
	  {
		out.println("<br><table class='table table-bordered display' id='table_id'>");
		out.println("<thead class='thead-light'>");
		out.println("<tr>");out.println("<th>fdate</th>");out.println("<th>user_id</th>");out.println("<th>name</th>");out.println("<th>mobile</th>");out.println("<th>feedback</th>");		out.println("</tr>");
		out.println("</thead>");
		out.println("<tbody>");
